...
class AdapterItemOrderDahuy(private val list: List<OrderDaHuy>): RecyclerView.Adapter<AdapterItemOrderDahuy.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       holder.itemView.apply {
           ...
           val lyDoHuy= findViewById<TextView>(R.id.txtLydo)
           ...
           lyDoHuy.text= list[position].lyDoHuy
       }
    }
